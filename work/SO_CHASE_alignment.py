...
plot = go.Figure(data = [plot_Spacecraft_model('SOLO', datetime(2023,3,28), scale=50),
                         plot_planet_model('earth',datetime(2023,3,28),radius=10),
                         plot_sun(crid=crid,surface_data='AIA_193',scale=10),
                         plot_object_orbit('SOLO', dt_epoch, type='line', color='white', width=6),
                         ...
                         plot_slice_sun_object(crid,'helio',param='vr',object_name='earth',object_dt=datetime(2023,3,28),z_offset=10.,colorscale='plasma',clim=[800,1600]),
                         plot_object_orbit('earth',dt_epoch,type='line',color='blue',width=6),
                         ],
                 frames = [go.Frame(data=[plot_Spacecraft_model('SOLO', dt_tmp, scale=50),
                                          plot_planet_model('earth',dt_tmp,radius=10),])
                           for dt_tmp in dt_epoch[::4]],
