...
spice.furnsh('kernels_loc/naif0012.tls')  # !!! for OSX
# Needed for Earth
spice.furnsh('kernels_loc/de430.bsp')
spice.furnsh('kernels_loc/pck00010.tpc')
# Needed for PSP
spice.furnsh('kernels_loc/spp_v300.tf')
spice.furnsh('kernels_loc/spp_2018_224_2025_243_RO5_00_nocontact.alp.bc')
spice.furnsh('kernels_loc/spp_001.tf')
spice.furnsh('kernels_loc/spp_dyn_v201.tf')
spice.furnsh('kernels_loc/spp_wispr_v002.ti')
spice.furnsh('kernels_loc/spp_sweap_v100.ti')
spice.furnsh('kernels_loc/spp_sclk_0866.tsc')
spice.furnsh('kernels_loc/spp_nom_20180812_20250831_v039_RO6.bsp')
# Load Attitude
...
spice.furnsh('All_reconstructed_ephemeris_loc/spp_recon_20210101_20210226_v001.bsp')
spice.furnsh('All_reconstructed_ephemeris_loc/spp_recon_20210226_20210325_v001.bsp')
spice.furnsh('All_reconstructed_ephemeris_loc/spp_recon_20210325_20210525_v001.bsp')
spice.furnsh('All_reconstructed_ephemeris_loc/spp_recon_20210524_20210723_v001.bsp')
spice.furnsh('All_reconstructed_ephemeris_loc/spp_recon_20210723_20210904_v001.bsp')
spice.furnsh('All_reconstructed_ephemeris_loc/spp_recon_20210904_20211104_v001.bsp')


AU = 1.49e8  # distance from sun to earth

spice.furnsh('kernels_loc/solo/solo_ANC_soc-sci-fk_V08.tf')
spice.furnsh('kernels_loc/solo/solo_ANC_soc-orbit-stp_20200210-20301120_247_V1_00229_V01.bsp')
